...
#' parameters following Case 26 and emplying a sampling resolution of
...
#' changes in growth rate or changes in /eqn{\delta^(18)O_w}{δ18Ow} but with a
#' shorter (6 yr) record length.
#' 
